...
Xtrain_path = "hf://datasets/SrikanthRama/PIMA-Diabetes-Prediction/Xtrain.csv"                    # enter the Hugging Face username here
Xtest_path = "hf://datasets/SrikanthRama/PIMA-Diabetes-Prediction/Xtest.csv"                      # enter the Hugging Face username here
ytrain_path = "hf://datasets/SrikanthRama/PIMA-Diabetes-Prediction/ytrain.csv"                    # enter the Hugging Face username here
ytest_path = "hf://datasets/SrikanthRama/PIMA-Diabetes-Prediction/ytest.csv"                      # enter the Hugging Face username here
...
repo_id = "SrikanthRama/PIMA-Diabetes-Prediction"                                         # enter the Hugging Face username here
repo_type = "model"
